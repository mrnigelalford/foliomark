/* Javascript output generated by archetype 1.2.14 */
                            ...
                            args: [
                              {
                                prim: 'pair',
                                args: [
                                  { prim: 'address', annots: ['%partAccount'] },
                                  { prim: 'nat', annots: ['%partValue'] },
                                ],
                              },
                            ],
                          },
                ...
                args: [
                  {
                    ...
                    args: [
                      { prim: 'unit', annots: ['%unpause'] },
                      {
                        prim: 'pair',
                        args: [
                          { prim: 'string', annots: ['%ikey'] },
                          { prim: 'bytes', annots: ['%idata'] },
                        ],
                        annots: ['%set_metadata'],
                      },
                    ],
                ...
                args: [
                  {
                    prim: 'or',
                    args: [
                      { prim: 'nat', annots: ['%set_default_expiry'] },
                      {
                        prim: 'pair',
                        args: [
                          {
      ...
      [
        {
          prim: 'LAMBDA',
          args: [
            { prim: 'pair', args: [{ prim: 'string' }, { prim: 'bool' }] },
            { prim: 'bool' },
            [
              { prim: 'UNPAIR', args: [{ int: '2' }] },
                    ...
                    { prim: 'GET' },
                    {
                      ...
                      args: [
                        [
                          {
                            prim: 'PUSH',
                            args: [{ prim: 'string' }, { string: 'permits' }],
                          },
                          {
                            prim: 'PUSH',
                            args: [
                    ...
                    { prim: 'EDIV' },
                    {
                      ...
                      args: [
                        [
                          {
                            prim: 'PUSH',
                            args: [{ prim: 'string' }, { string: 'DivByZero' }],
                          },
                          { prim: 'FAILWITH' },
                        ],
                        [],
        ...
        {
          prim: 'DIP',
          args: [{ int: '1' }, [{ prim: 'UNPAIR', args: [{ int: '11' }] }]],
        },
        {
          prim: 'IF_LEFT',
          args: [
              ...
              { prim: 'GET' },
              {
                ...
                args: [
                  [
                    {
                      prim: 'PUSH',
                      args: [{ prim: 'string' }, { string: 'royalties' }],
                    },
                    {
                      prim: 'PUSH',
